...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        // dados da empresa
        empresa.razaoSocial = "Joice SA";
        empresa.nomeFantasia = "Joice Não Chega Atrasada";
        empresa.cnpj = "12.345.678/0001-90";
        empresa.email = "joicenca@nca.com.br";
        empresa.telefone = "(11) 98765-4321";
        empresa.endereco = "Rua das Flores, 123 - São Paulo/SP";
        empresa.website = "www.joicenca.com.br";
