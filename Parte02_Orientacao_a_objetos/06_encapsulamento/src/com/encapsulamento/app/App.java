...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        // dados da empresa
        empresa.setNomeFantasia("Deixe de Preguiça e Bora Estudar");
        empresa.setCnpj("09.780.602/0001-58");
        empresa.setEmail("boraestudar@bora.com.br");
        empresa.setTelefone("(61) 98348-4268");
