...
import com.atividade07.models.ContaFisica;
import com.atividade07.models.ContaJuridica;

public class App {
    public static void main(String[] args) throws Exception {
        Scanner sc = new Scanner(System.in);
        PessoaFisica pf = new PessoaFisica(null, null, null);
        ContaFisica ccpf = new ContaFisica("1234-5", "10101-1", 0, pf);
        PessoaJuridica pj = new PessoaJuridica(null, null, null, null);
        ContaJuridica ccpj = new ContaJuridica("1234-5", "20101-1", 0, pj);
...
// nome, email e cpf (classe PessoaFísica), ou nome fantasia, razão social,
// email e cnpj (classe PessoaJuridica), e o programa deverá informar a 
// agencia e conta (classe Conta) do titular (os dados do usuario serão sitados
// uma única vez durantre todo o programa). 
// Em seguida, o programa deverá exibir as opções para o 
// usuário: consultar dados da conta, fazer saque, fazer depósito, sair do 
// programa. O programa deverá cobrar uma taxa de 0,01% em cima de cada
// saque feito pela pessoa jurídica. Qualquer saque só poderá ser feito 
// caso o valor do saque seja menor ou igual ao saldo da conta.
